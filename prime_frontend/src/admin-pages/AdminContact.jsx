    ...
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100">
      ...
      <div className="hidden lg:block fixed left-0 top-0 h-full w-64 bg-white shadow-xl">
        <div className="p-6">
          ...
          >
            <div className="w-12 h-12 bg-linear-to-br from-red-600 to-red-800 rounded-xl flex items-center justify-center shadow-lg">
              <FiGlobe className="w-6 h-6 text-white" />
            </div>
            <div>
              <h2 className="text-xl font-bold bg-linear-to-r from-red-600 to-red-800 bg-clip-text text-transparent">
                Prime Print
              </h2>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <h1 className="text-xl font-bold bg-linear-to-r from-red-800 to-red-600 bg-clip-text text-transparent">
                    Contact Management
                  </h1>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex justify-end space-x-2 mt-6">
                  <motion.button
                    ...
                    className="px-4 py-2 bg-linear-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-red-800"
                  >
                    Delete
                  </motion.button>
                  <motion.button
